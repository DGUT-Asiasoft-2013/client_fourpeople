package com.example.fourpeople.campushousekeeper.auction.view;
...
public class AuctionnerView extends View {

    public AuctionnerView(Context context) {
        super(context);
    }

    public AuctionnerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AuctionnerView(Context context, AttributeSet attrs, int defStyleAttr) {
