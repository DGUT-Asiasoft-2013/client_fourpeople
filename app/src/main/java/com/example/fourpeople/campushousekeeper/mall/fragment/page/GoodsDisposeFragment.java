...
public class GoodsDisposeFragment extends Fragment {
    ...
    MallPictureInputFragment goodsDispose_avatar;
    Button goodsPush;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.mall_fragment_goodsdispose, null);
            ...
            goodsDispose_avatar = (MallPictureInputFragment) getFragmentManager().findFragmentById(R.id.goodsDispose_avatar);
            ...
            linearLayout = (LinearLayout) view.findViewById(R.id.fragment_goodsdispose);
