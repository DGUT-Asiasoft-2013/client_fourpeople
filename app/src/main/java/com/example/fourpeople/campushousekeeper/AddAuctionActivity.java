...
public class AddAuctionActivity extends Activity {
    ...
    void initView() {
            ...
            public void onClick(final View v) {
                if (isOpen == false) {
                  ...
                  runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ImageButton) v).setImageDrawable(getResources().getDrawable(R.drawable.drag_down));
                        }
                    });
                    //isOpen=true;
                } else {
                 ...
                 getFragmentManager().beginTransaction().remove(menuFragment).commit();
                   runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            ((ImageButton) v).setImageDrawable(getResources().getDrawable(R.drawable.menu));
                        }
                    });
                    // isOpen=false;
                }
        ...
        ArrayAdapter<CharSequence> ada = ArrayAdapter.createFromResource(this, R.array.auction_method, R.layout.spinner_item);
