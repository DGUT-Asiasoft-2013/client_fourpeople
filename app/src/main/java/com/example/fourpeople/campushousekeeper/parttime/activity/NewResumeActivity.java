...
import com.example.fourpeople.campushousekeeper.parttime.fragments_widgets.PartPictureInputFragment;
...
public class NewResumeActivity extends Activity{
    ...
    PartPictureInputFragment avata;
     RadioGroup sex=null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.part_activity_newresume);
        //取出单选按钮的数据
        ...
        avata=(PartPictureInputFragment)getFragmentManager().findFragmentById(R.id.choice_image);
