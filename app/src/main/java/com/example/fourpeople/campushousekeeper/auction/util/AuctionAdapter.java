...
public class AuctionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {/*
         ViewHolder holder;
        if (convertView==null) {
           // convertView = View.inflate(context, R.layout.auction_fragment_auction_item, null);
        ...
        if (convertView == null) {
            ...
            //holder = new ViewHolder();
            LayoutInflater layoutInflater = LayoutInflater.from(context);
            itemview = layoutInflater.inflate(R.layout.auction_fragment_auction_item, null);
        } else {
            // holder = (ViewHolder) convertView.getTag();
            itemview = convertView;
        }
        TextView auctionName = (TextView) itemview.findViewById(R.id.tv_auctionners);
        AuctionnerView auctionnerView = (AuctionnerView) itemview.findViewById(R.id.img_picture);
        ...
        auctionnerView.load(Server.serverAddress + auctionData.get(position).getPicture());
        // convertView.setTag(holder);
        Log.d("view", auctionData.get(position).toString());
        return itemview;
    }
